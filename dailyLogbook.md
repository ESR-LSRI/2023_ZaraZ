...
* iButton 18 (site 9) — only location info is “crater rim”, no installation data, no GPS
* iButton 20 (site 9) — only location info is “in the mount baker dox/dot at summit”, no installation data, no GPS
